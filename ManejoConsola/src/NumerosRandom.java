...
public class NumerosRandom {
    public static void main(String[] args) {
        ...
        var numeroAleatorio = random.nextInt(10); //se generara un valor aleatorio entre 0 y 9
        ...
        System.out.println("flotanteAleatorio = %.2f".formatted(flotanteAleatorio)); //aplicando formateado de decimales
        System.out.println("flotanteAleatorio = " + flotanteAleatorio);

        // Simular el lanzamiento de un dado (1 y 6)
        var simulacionDado = random.nextInt(6) + 1;
        System.out.println("Resultado de lanzar el dado = " + simulacionDado);
    }
}
